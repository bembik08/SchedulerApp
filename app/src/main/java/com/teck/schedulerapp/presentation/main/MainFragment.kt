    ...
    private fun addLessenWatcher(data: Classes) {
        ...
        timer = object : CountDownTimer(different*1000, COUNT_DOWN_LATCH) {
            override fun onTick(millisUntilFinished: Long) {
                val dayDecimal = (millisUntilFinished / SECONDS_IN_SHIFT) / DECIMAL
                val day = (millisUntilFinished / SECONDS_IN_SHIFT) % DECIMAL
                val diffHour = millisUntilFinished % SECONDS_IN_SHIFT
